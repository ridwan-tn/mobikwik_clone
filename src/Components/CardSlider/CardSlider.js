          ...
          <div className="row mt-5">
            ...
            >
              ...
              <div className="buttons">
                <button
                  ...
                  onClick={() => {
                    if (current_item === 0) {
                      ...
                      carousel_container.current[index].style.transition =
                        "none";
                      carousel_container.current[
                        index
                      ].style.transform = `translate(${-325 * current_item}px)`;
                    } else {
                ...
                <Link
                  to={{
                    pathname: `/offers/${section[index]}`,
                    data: { items: store[index], section: section[index] },
                  }}
                >
