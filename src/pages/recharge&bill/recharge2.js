          ...
          <Grid item container>
            <Paper className={classes.paper}>
              ...
              <TabPanel value={value} className={classes.tabpanel} index={0}>
                    ...
                    <TextField
                      ...
                      onChange={(e) => {
                        if (e.target.value.toString().length == 10) {
                          setCount(
                            <Typography style={{ color: "rgb(87,87,87)" }}>
                          ...
                          setState({
                            username: (
                              <Card className={classes.rechargecard1}>
                                ₹128
                                <br /> Special offer|Validty:28days
                              </Card>
                            ),
                            password: (
                              <Card className={classes.rechargecard1}>
                                ₹129
                                <br /> Special offer:1Gb|Validty:24days
                              </Card>
                            ),
                            offer1: (
                              <Card className={classes.rechargecard1}>
                                ₹149
                                <br /> Special offer:2Gb|Validty:28days
                              </Card>
                            ),
                            offer2: (
                              <Card className={classes.rechargecard1}>
                                ₹199
                                <br /> Special
                                offer:24Gb(1Gb/day)|Validty:24days
                              </Card>
                            ),
                            offer3: (
                              <Card className={classes.rechargecard1}>
                                ₹219
                                <br /> Special
                                offer:28Gb(1Gb/day)|Validty:28days
                              </Card>
                            ),
                          });
                ...
                <Grid item container>
                  <Grid md={2}>{form.username}</Grid>
                  <Grid md={3}>{form.password}</Grid>
                  <Grid md={3}>{form.offer1}</Grid>
                  <Grid md={3}>{form.offer2}</Grid>
                  ...
                  <Grid item md={5}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField
                          {...params}
                          placeholder="AAVAS FINANCIERS LIMITED"
                          variant="outlined"
                          margin="dense"
                        />
                      )}
                  ...
                  <Grid item md={5}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField
                          {...params}
                          placeholder="Ahamedabad Muncipal Corporation"
                          variant="outlined"
                          margin="dense"
                        />
                      )}
                  ...
                  <Grid item md={5}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField
                          {...params}
                          placeholder="Bharath Petrolium Coperation Limited(BPCL)"
                          variant="outlined"
                          margin="dense"
                        />
                      )}
              ...
              <CardContent>
                ...
                <Box m={1} css={{ maxWidth: 250 }}>
                  <Typography className={classes.content20}>
                    With money loaded in your MobiKwik wallet, it takes seconds
                    to make phone and DTH recharges!
                  </Typography>
                </Box>
              </CardContent>
            </Card>
          ...
          <Box width="100%">
            <Card elevation={0}>
              <CardContent>
                ...
                <Box m={1} css={{ maxWidth: 250 }}>
                  <Typography className={classes.content20}>
                    Get an instant ₹5,00,000 credit in your wallet in less than
                    5 Minutes.
                  </Typography>
                </Box>
              </CardContent>
          ...
          <Box p={1}>
            ...
            <Box>
              <Typography className={classes.paracontent}>
                MobiKwik is India's largest digital payments platform, serving
                12 crore+ users with quick transactions, money transfer, credit
          ...
          <Box p={1}>
            ...
            <Box>
              <Typography className={classes.paracontent}>
                ...
                ! MobiKwik covers all the top operators in India like Airtel,
                Jio, MTNL, Vi, Dish TV, Tata Sky & more. Just not that, but you
                can also pay all your utility bills like
                <span style={{ color: "rgba(29 146 222)" }}>
                  electricity bills
                </span>
                ...
                discount and cashback offers everytime you pay. So, just
                download the MobiKwik app and rest will be taken care of.
              </Typography>
            </Box>
          </Box>
        </Box>
          ...
          <Box p={1}>
            ...
            <Box>
              <Typography className={classes.paracontent}>
                ...
                facilities for their users. One can opt for Mutual funds,
                Digital Gold,
                <span style={{ color: "rgba(29 146 222)" }}>Instant Loans</span>
                , Money Transfers, Pay later & more services. With MobiKwik,
                users can invest in the right Mutual Fund starting at just ₹100
                giving them the liberty to start small and build their
                investment portfolio with several investment options. Also with
                MobiKwik’s spend now, pay later service - ZIP, one can get a
                credit up to ₹30,000 at ZERO cost to shop, pay bills and much
                more, making it easier for the users to manage cash crunch.
              </Typography>
            </Box>
          </Box>
        </Box>
