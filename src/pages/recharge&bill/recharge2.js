...
const[amount,setAmount]=useState('');
  ...
  switch (name) {
     ...
     default:
      ...
      <TextField inputProps={{ maxLength: 10 }}   style={{ width:"100%",height:"" }}placeholder="Number" variant="outlined" type="text" margin="dense" pattern="[0-9]*"
    ...
    />
      ...
      <Grid item md={1} xs={2}style={{float:"left"}}>
      <Button
        variant="contained"
      ...
      <Grid item md={1} style={{float:"left"}}>
      <Button
        variant="contained"
